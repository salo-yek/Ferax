...
export function GeneralSection() {
  ...
  const autoExecute = usePreferencesStore((s) => s.autoExecute);
  const autoEdit = usePreferencesStore((s) => s.autoEdit);
    ...
    <div className="flex flex-col gap-6">
              ...
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  ...
                  >
                    ...
                    Turn this off as a fallback â€” performance dips slightly,
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="When enabled, bash commands (bash_run, bash_background) execute immediately without asking for approval. Cycle detection prevents infinite loops from repeated failing commands. Use with caution."
        >
          <Switch
            checked={autoExecute}
            onCheckedChange={(v) => void setAutoExecute(v)}
          />
        </SettingRow>
        <SettingRow
          title="Auto-edit files"
          description="When enabled, file edits (edit, multi_edit, write_file, create_directory) apply immediately without asking for approval. The read-before-edit invariant still applies. Use with caution."
        >
          <Switch
            checked={autoEdit}
            onCheckedChange={(v) => void setAutoEdit(v)}
          />
        </SettingRow>
        <SettingRow
          title="Coding agent notifications"
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when Ferax is unfocused, in-app otherwise."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open Ferax automatically when you sign in."
          >
            <Switch
              checked={autostart}
