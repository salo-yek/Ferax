...
const REPO_URL = "https://github.com/salo-yek/Ferax";
const WEBSITE = "https://nimbo.fun/saloyek/ferax";
...
export function AboutSection() {
  ...
  const [name, setName] = useState("Ferax");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">app.saloyek.ferax</dd>
