...
export const DEFAULT_THEME_ID = "ferax-default";
...
const STORE_PATH = "ferax-settings.json";
...
const KEY_AUTO_EXECUTE = "autoExecute";
const KEY_AUTO_EDIT = "autoEdit";
...
// window can listen.
const PREFS_CHANGED_EVENT = "ferax://prefs-changed";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    autoExecute:
      get<boolean>(KEY_AUTO_EXECUTE) ?? DEFAULT_PREFERENCES.autoExecute,
    autoEdit:
      get<boolean>(KEY_AUTO_EDIT) ?? DEFAULT_PREFERENCES.autoEdit,
    shortcuts:
...
export async function setAutoExecute(value: boolean): Promise<void> {
  await writePref(KEY_AUTO_EXECUTE, value);
}

export async function setAutoEdit(value: boolean): Promise<void> {
  await writePref(KEY_AUTO_EDIT, value);
}
...
export async function onPreferencesChange(
  ...
  const map: Record<string, PrefKey> = {
    ...
    [KEY_AUTO_EXECUTE]: "autoExecute",
    [KEY_AUTO_EDIT]: "autoEdit",
...
const KEYS_CHANGED_EVENT = "ferax://ai-keys-changed";
