...
const AGENT_EVENT: &str = "Ferax:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[Ferax: dropped output due to backpressure]\x1b[0m\r\n";
